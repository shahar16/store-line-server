...
const JBL = {
    ...
    products: {
        ...
        Flip5: {
            ...
            price: 424.99,
            image: [
                `${imagesPrefix}/flip_5/pic1.jpg`,
                `${imagesPrefix}/flip_5/pic2.jpg`,
                `${imagesPrefix}/flip_5/pic3.jpg`,
                `${imagesPrefix}/flip_5/pic4.jpg`,
                `${imagesPrefix}/flip_5/pic5.jpg`,
                `${imagesPrefix}/flip_5/pic6.jpg`,
            ],
            stock: {
                type: 'color',
                quantities: {
