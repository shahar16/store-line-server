...
exports.seedUsers = async (req, res, next) => {
    ...
    const users = [
        ...
        { email: "vehicula.et.rutrum@DonectinciduntDonec.co.uk", password: "16741211", firstName: "djhqj", lastName: "bbbcm" },
        ...
        { email: "turpis.nec.mauris@odioauctorvitae.co.uk", password: "16510420", firstName: "djhqj", lastName: "bbbcm" },
